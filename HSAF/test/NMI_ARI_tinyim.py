...
model_path='/home/data3t/zhaoyuxiang/CL/ckpt/genggai_moco/tiny/epoch_300.pth'

model=ResNet(depth=18,num_classes=200,maxpool=False,zero_init_residual=True).to(device)
...
data=ImageFolder(root='/home/data3t/zhaoyuxiang/CL/Data/tiny-imagenet-200/val',transform=transfomer)
